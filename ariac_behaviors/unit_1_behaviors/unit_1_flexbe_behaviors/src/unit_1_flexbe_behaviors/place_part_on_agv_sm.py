	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('look for part hight',
										...
										transitions={'found': 'robot case structure', 'not_found': 'failed'},
			...
			OperatableStateMachine.add('compute placing on AGV1',
										...
										remapping={'move_group': 'move_group', 'action_topic_namespace': 'robot1_namespace', 'tool_link': 'tool_link', 'pose': 'AGV_pose', 'offset': 'part_height', 'rotation': 'zero', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})

			# x:977 y:539
			OperatableStateMachine.add('compute placing on AGV2',
										ComputeGraspAriacState(joint_names=['linear_arm_actuator_joint', 'shoulder_pan_joint', 'shoulder_lift_joint', 'elbow_joint', 'wrist_1_joint', 'wrist_2_joint', 'wrist_3_joint']),
										transitions={'continue': 'actual placing on top of AGV2', 'failed': 'compute placing on AGV2'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'move_group': 'move_group', 'action_topic_namespace': 'robot2_namespace', 'tool_link': 'tool_link', 'pose': 'AGV_pose', 'offset': 'part_height', 'rotation': 'zero', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})
			...
			OperatableStateMachine.add('get location agv1',
										...
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'ref_frame': 'ref_frame', 'frame': 'frameAGV1', 'pose': 'AVGpose'})
			...
			OperatableStateMachine.add('get location agv2',
										...
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'ref_frame': 'ref_frame', 'frame': 'frameAGV2', 'pose': 'AVGpose'})
